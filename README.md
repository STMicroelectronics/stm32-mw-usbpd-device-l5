# STM32L5 Device-Specfic USB Power Delivery Middleware Library MCU Software Component
...
This repository provides the STM32Cube **device-specific** Middleware Library of the **STM32CubeL5** MCU firmware for managing the **USB Type-C** physical layer.
